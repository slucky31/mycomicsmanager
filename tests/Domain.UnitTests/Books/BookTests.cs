...
public class BookTests
{
    ...
    {
        // Arrange
        var series = "The Sandman";
        var title = "Preludes & Nocturnes";
        var isbn = "9781401284770";
    ...
    public void Create_Should_CreateBookWithVolumeNumber()
    {
        // Arrange
        var series = "The Sandman";
        var title = "The Doll's House";
        var isbn = "9781401284787";
        var volumeNumber = 2;
    ...
    public void Create_Should_CreateBookWithAllProperties()
    {
        // Arrange
        var series = "The Sandman";
        var title = "Dream Country";
        var isbn = "9781401284794";
        var volumeNumber = 3;
    ...
    public void AddReadingDate_Should_AddMultipleReadingDates()
    {
        ...
        var note1 = "First reading";
        var note2 = "Second reading";
